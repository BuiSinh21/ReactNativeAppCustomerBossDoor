...
import { resetTimeWorking } from '../../../redux/slices/timeWorking';
...
const ListNavigation = () => {
    ...
    const handleLogout = async () => {
        try {
            ...
            dispatch(resetTimeWorking());
            navigate.reset({
                index: 0,
                routes: [{ name: ROOT_ROUTES.BOTTOM_TAB_STACK }],
            });
    ...
    return (
        <View style={[sty.flex_1]}>
            <View style={[sty.flexRow,sty.itemsCenter,sty.gap_12,sty.mb_12]}>
                <Image source={
                    user && user.avatar
                        ? { uri: user.avatar }
                ...
                <TextDisplay color={appColor.textBlack} fontWeight='medium' text={user.full_name} />
            </View>
