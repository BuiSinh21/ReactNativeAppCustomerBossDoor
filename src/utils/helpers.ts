...
export const getFontFamilyBeViet = (
  fontWeight: 'bold' | 'semibold' | 'medium' | 'regular' | 'light' | undefined,
) => {
  switch (fontWeight) {
    case 'bold':
      return FONT_FAMILY.BeVietnamPro_Bold;
    case 'semibold':
      return FONT_FAMILY.BeVietnamPro_SemiBold;
    case 'medium':
      return FONT_FAMILY.BeVietnamPro_Medium;
    case 'regular':
      return FONT_FAMILY.BeVietnamPro_Regular;
    case 'light':
      return FONT_FAMILY.BeVietnamPro_Light;
    default:
      return FONT_FAMILY.BeVietnamPro_Regular;
  }
};
